...
object Equalities {
  ...
  /**
    ...
    */
  implicit val solrServerStatusEquality: Equality[SolrServer] =
    scalactic.Equality(new Uniformity[SolrServer] {
      ...
      override def normalized(a: SolrServer): SolrServer =
        normalizedOrSame(a).asInstanceOf[SolrServer]
